...
public class Text: Container {
    public string text;
    SpriteFont f = font;
    public new Vector2 PositionTopLeft { get => parent.PositionTopLeft + (parent.Size - Size)/2; }
...
public class Container
{
    ...
    public Container(Vector2 Position, Vector2 Size) { // static
        children = new List<Container>();
        this.PositionTopLeft = Position;
        this.Size = Size;
    }
    
    public Container() { // dynamic
        children = new List<Container>();
    }
